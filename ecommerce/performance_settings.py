...
# Este arquivo contém configurações otimizadas para performance em produção
...
# Media Files (para produção, usar CDN)
...
MIDDLEWARE = [
    ...
    'django.middleware.gzip.GZipMiddleware',  # Compressão
]
